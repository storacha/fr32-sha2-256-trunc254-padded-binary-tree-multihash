import type { MultihashDigest, MultihashHasher, SyncMultihashHasher, Phantom } from "multiformats";
/**
...
export interface Digest<Code extends number, Size extends number> extends MultihashDigest<Code> {
    size: Size;
}
export interface Hasher<Code extends number, Size extends number> extends MultihashHasher<Code> {
    size: Size;
    /**
     ...
     */
    digestInto(input: Uint8Array, output: Uint8Array, offset?: number, asMultihash?: boolean): void | Promise<void>;
}
export interface SyncHasher<Code extends number, Size extends number> extends SyncMultihashHasher<Code> {
    size: Size;
     ...
     * written otherwise only the digest (without multihash prefix) is written.
     */
    digestInto(input: Uint8Array, output: Uint8Array, offset?: number, asMultihash?: boolean): void;
}
