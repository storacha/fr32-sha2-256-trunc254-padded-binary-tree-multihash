...
export function piecehasher_digestInto(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function create(): number;
export function reset(a: number): void;
export function readHashInto(a: number, b: number, c: number, d: number, e: number): void;
